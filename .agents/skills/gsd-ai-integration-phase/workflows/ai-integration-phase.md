...
```markdown
Read ~/.gemini/antigravity/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "$HOME/.gemini/antigravity/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read ~/.gemini/antigravity/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read ~/.gemini/antigravity/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read ~/.gemini/antigravity/agents/gsd-eval-planner.md for instructions.
