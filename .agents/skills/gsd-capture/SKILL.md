...
<execution_context>
@.agents/skills/gsd-capture/workflows/add-todo.md
@.agents/skills/gsd-capture/workflows/note.md
@.agents/skills/gsd-capture/workflows/add-backlog.md
@.agents/skills/gsd-capture/workflows/plant-seed.md
@.agents/skills/gsd-capture/workflows/check-todos.md
@.agents/skills/gsd-capture/references/ui-brand.md
</execution_context>
