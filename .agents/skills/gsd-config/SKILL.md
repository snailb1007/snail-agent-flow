...
<execution_context>
@.agents/skills/gsd-config/workflows/settings.md
@.agents/skills/gsd-config/workflows/settings-advanced.md
@.agents/skills/gsd-config/workflows/settings-integrations.md
</execution_context>
