...
<execution_context>
@.agents/skills/gsd-mvp-phase/workflows/mvp-phase.md
@.agents/skills/gsd-mvp-phase/references/spidr-splitting.md
@.agents/skills/gsd-mvp-phase/references/user-story-template.md
</execution_context>
