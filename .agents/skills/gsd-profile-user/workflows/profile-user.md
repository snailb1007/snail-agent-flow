...
Key references:
- @$HOME/.gemini/antigravity/get-shit-done/references/ui-brand.md (display patterns)
- @$HOME/.gemini/antigravity/agents/gsd-user-profiler.md (profiler agent definition)
- @$HOME/.gemini/antigravity/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
cp "$HOME/.gemini/antigravity/get-shit-done/USER-PROFILE.md" "$HOME/.gemini/antigravity/USER-PROFILE.backup.md"
```
...
✓ Stores profile at $HOME/.gemini/antigravity/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `$HOME/.gemini/antigravity/get-shit-done/references/user-profiling.md`
...
Reference: @$HOME/.gemini/antigravity/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to $HOME/.gemini/antigravity/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global GEMINI.md" -- "Add profile to $HOME/.gemini/antigravity/GEMINI.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at $HOME/.gemini/antigravity/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at $HOME/.gemini/antigravity/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to $HOME/.gemini/antigravity/GEMINI.md"
...
```bash
BACKUP_PATH="$HOME/.gemini/antigravity/USER-PROFILE.backup.md"
```
...
Your profile:    $HOME/.gemini/antigravity/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   $HOME/.gemini/antigravity/skills/gsd-dev-preferences/SKILL.md
  ✓ GEMINI.md section       ./GEMINI.md
  ✓ Global GEMINI.md        $HOME/.gemini/antigravity/GEMINI.md
```
