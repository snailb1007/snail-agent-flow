...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@~/.gemini/antigravity/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `~/.gemini/antigravity/get-shit-done/workflows/transition.md`.
...
- Follow @~/.gemini/antigravity/get-shit-done/workflows/diagnose-issues.md
