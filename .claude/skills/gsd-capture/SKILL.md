...
<execution_context>
@.claude/skills/gsd-capture/workflows/add-todo.md
@.claude/skills/gsd-capture/workflows/note.md
@.claude/skills/gsd-capture/workflows/add-backlog.md
@.claude/skills/gsd-capture/workflows/plant-seed.md
@.claude/skills/gsd-capture/workflows/check-todos.md
@.claude/skills/gsd-capture/references/ui-brand.md
</execution_context>
