...
<execution_context>
@.claude/skills/gsd-config/workflows/settings.md
@.claude/skills/gsd-config/workflows/settings-advanced.md
@.claude/skills/gsd-config/workflows/settings-integrations.md
</execution_context>
