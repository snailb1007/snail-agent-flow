...
<execution_context>
@.claude/skills/gsd-mvp-phase/workflows/mvp-phase.md
@.claude/skills/gsd-mvp-phase/references/spidr-splitting.md
@.claude/skills/gsd-mvp-phase/references/user-story-template.md
</execution_context>
