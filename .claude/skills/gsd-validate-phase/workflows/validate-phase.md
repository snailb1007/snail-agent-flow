...
```
Agent(
  prompt="Read ~/.gemini/antigravity/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `~/.gemini/antigravity/get-shit-done/templates/VALIDATION.md`
