...
- [x] [#57](https://github.com/snailb1007/snail-agent-flow/issues/57) (S4) — lib/profile-scorer.js + test suite
...
- [x] 19-01-PLAN.md — lib/claim-manager.js + test suite
...
- [x] 20-01-PLAN.md — lib/lease-manager.js + TTL/heartbeat daemon
- [x] 20-02-PLAN.md — Concurrency lock checks in flow execution path
...
- [x] 21-01-PLAN.md — Checkpoint generation and ADR lock validators
...
- [x] [#58](https://github.com/snailb1007/snail-agent-flow/issues/58) (S5) — lib/signal-logger.js + metrics compiler
...
- [x] 23-01-PLAN.md — Failure recovery policies in flow engine
- [x] 23-02-PLAN.md — Integration with `adp validate-spec`, `adp doctor`, and strict init checks
