...
This project is indexed by GitNexus as **snail-agent-flow** (923 symbols, 997 relationships, 2 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
